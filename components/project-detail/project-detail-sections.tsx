...
function ProjectHeroMedia({ project, visualType }: { project: ProjectRecord; visualType: ProjectVisualType }) {
  return <figure className={`project-detail-hero-media${project.image ? " has-approved-image" : " has-fallback-only"}`}><ProjectFallbackVisual project={project} visualType={visualType} />{project.image ? <img src={(project.image.heroSourceUrl || project.image.sourceUrl)} alt={project.image.alt.ar} /> : null}</figure>;
}
          ...
          <div className="project-detail-primary">
            <section className="project-detail-hero" aria-labelledby="project-title">
              ...
              <div className="project-detail-hero-copy">
                ...
                {detail.isFallback ? <p className="fallback-detail-label">تظهر هنا المعلومات المتاحة عن المشروع، وتُضاف التحديثات عند نشرها.</p> : null}
              </div>
            </section>
