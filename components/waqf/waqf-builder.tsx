...
export function WaqfBuilder({projects}:{projects:Project[]}){
 ...
 return <div className="simple-giving-builder" id="waqf-builder">
  ...
  <section className="builder-review"><span>4</span><div><h3>مراجعة الاختيار</h3><dl><div><dt>المشروع</dt><dd>{project?.title??"—"}</dd></div><div><dt>المبلغ</dt><dd>{value>0?`${value.toFixed(2)} USD`:"—"}</dd></div><div><dt>صاحب الوقف</dt><dd>{owner||"—"}</dd></div></dl></div></section>
