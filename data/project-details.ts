...
const projectDetails: Record<string, ProjectDetailRecord> = {
  "gaza-food-parcels": {
    ...
    updates: [
      { id: "parcels-plan", dateLabel: "التاريخ مطلوب", stage: "التجهيز", title: "خطة تجهيز الطرود", description: "يُضاف نطاق التجهيز والكميات بعد اعتماد الفريق الميداني.", sourceLabel: "مصدر التوثيق مطلوب", status: "planned", mediaLabel: "مواد ميدانية إضافية تُنشر عند توفرها." },
    ...
    proofItems: [
      ...
      { label: "تقرير المشروع", status: "later", note: "سيظهر التقرير عند نشره." },
      { label: "جهة التنفيذ", status: "verification", note: "بيانات الجهة المنفذة قيد التحقق." },
    ],
    media: [
      { kind: "image", label: "صور تجهيز الطرود", requirement: "صور ميدانية مرتبطة بالمشروع." },
      { kind: "video", label: "فيديو التسليم", requirement: "فيديو ميداني يُنشر عند توفره." },
    ],
  ...
  "gaza-hot-meals": {
    ...
    proofItems: [
      ...
      { label: "تقرير ميداني", status: "later", note: "سيظهر التقرير عند نشره." },
      { label: "مصدر البيانات", status: "verification", note: "قيد الربط بالتقارير الرسمية." },
    ],
    media: [{ kind: "video", label: "من المطبخ إلى التوزيع", requirement: "فيديو ميداني يُنشر عند توفره." }],
  ...
  "al-quds-home-restoration": {
    ...
    proofItems: [
      ...
      { label: "تقرير فني", status: "later", note: "سيظهر التقرير عند نشره." },
      { label: "إثبات التسليم", status: "later", note: "سيُضاف بعد اكتمال المشروع." },
    ],
    media: [
      { kind: "before-after", label: "قبل وبعد الترميم", requirement: "صور قبل وبعد تُنشر عند توفرها." },
      { kind: "image", label: "تفاصيل أعمال الترميم", requirement: "صور تفصيلية تُنشر عند توفرها." },
    ],
...
export function getProjectDetail(project: ProjectRecord): ResolvedProjectDetail {
  ...
  return {
    ...
    media: [{ kind: "image", label: "وسائط ميدانية إضافية", requirement: "مواد ميدانية إضافية تُنشر عند توفرها." }],
    acceptsGift: true,
    isFallback: true,
  };
}
