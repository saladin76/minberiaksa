...
const AR_CORRECTIONS: CorrectionMap = {
  ...
  "Footer.description": "جمعية منبر الأقصي الدولية للتضامن جمعية عاملة للنفع العام، تقف إلى جانب المحتاجين منذ عام 1961 في مجالات الصحة والإغاثة العاجلة والاستجابة للكوارث والتعليم.",
...
const EN_CORRECTIONS: CorrectionMap = {
  ...
  "HomePage.faq2Question": "Is volunteering with the Minberiaksa team paid?",
...
const DE_CORRECTIONS: CorrectionMap = {
  ...
  "QuickDonate.associationName": "Minberiaksa Hilfs- und Solidaritätsverein",
  ...
  "Footer.copyright": "© {year} Minberiaksa. Alle Rechte vorbehalten.",
