...
export const visualAssets: VisualAsset[] = [
  ...
  { id: "approved-islamic-pattern", type: "pattern", path: "/assets/patterns/aqsa-white-pattern.png", alt: "زخرفة مقدسية خفيفة", status: "approved", replacementNote: "Approved Aqsa white pattern" }
];
