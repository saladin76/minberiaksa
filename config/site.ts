export const siteConfig = {
  nameAr: "مؤسسة منبر الأقصى الدولية",
  shortNameAr: "منبر الأقصى",
  nameEn: "Minbar al-Aqsa Association",
  description:
    "مؤسسة إنسانية تعمل على دعم مشاريع القدس والأقصى وإغاثة أهل غزة.",
